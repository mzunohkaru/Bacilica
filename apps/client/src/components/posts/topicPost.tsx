...
const TopicPost = (props: TopicPostPropsType) => {
  return (
    <div className={`topics-post absolute transform ${props.frameStyle.join(' ')} flex flex-col items-center border-none rounded-xl bg-gradient-to-b from-[#D2D2D233] to-[#D0D0D073] text-lg transition-all ease-in-out duration-500`}>
      ...
      <div className={`relative w-full h-1/2`}>
        ...
        <p className='content flex flex-grow flex-row items-center'>AIによる要約</p>
