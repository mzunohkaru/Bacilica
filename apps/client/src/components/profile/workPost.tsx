...
const WorkPost = (props: WorkPostPropsType) => {
  return (
    <div className='article-post-container flex flex-row border-none rounded-xl bg-gradient-to-b from-[#D2D2D233] to-[#D0D0D073] p-2'>
      <Image
