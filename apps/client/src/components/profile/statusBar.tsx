...
const StatusBar = () => {
  return (
    <div className={`bg-gradient-to-b from-[#FFFFFFB8] to-[#A5A5A556] flex flex-col justify-start items-center text-black rounded-3xl w-[20vw] p-5 ${madimiOne.className}`}>
