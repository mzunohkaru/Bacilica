...
const Modal = forwardRef<HTMLDivElement, ModalProps>(
  ({ onClose, isLogin }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className='absolute inset-0 m-auto flex flex-row flex-grow justify-center items-center w-[70vw] h-[70vh] text-white text-5xl z-20 bg-[#FCEFFFC2]'
      >
        <button
          onClick={onClose}
        ...
        <section className='w-[50%] flex flex-col justify-center items-center'>
          ...
          <p className={`text-xl text-black my-8 ${madimiOne.className}`}>
            Get Started
          </p>
